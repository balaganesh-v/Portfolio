...
function Qualifications() {
    const qualifications = [
        {
            ...
            icon: <FaSchool className="text-blue-600 text-3xl" />,
        },
        {
            title: "HSC",
    ...
    return (
        <section
            id="qualification"
            className="py-24 px-6 bg-gradient-to-br from-[#eef4ff] via-white to-[#f4f8ff]"
        >
            <div className="max-w-5xl mx-auto">
                {/* Section Title */}
                <h2 className="text-4xl font-bold text-center text-blue-700 mb-20">
                    Qualifications
                </h2>
                ...
                <div className="relative">
                    {/* Vertical Line */}
                    <div className="absolute left-10 top-0 w-1 h-full bg-blue-300"></div>
                    ...
                    <div className="flex flex-col space-y-16">
                        {qualifications.map((q, idx) => (
                            <div key={idx} className="flex items-start relative">
                                {/* Icon Dot */}
                                <div className="absolute left-4 mt-2 w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center shadow-md z-10">
                                    {q.icon}
                                </div>
